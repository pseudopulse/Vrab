...
namespace Vrab.Skills {
    public class Deconstruct : SkillBase<Deconstruct>
    {
        ...
        public override string Description => "<style=cDeath>Slowing.</style> Liquify a target for <style=cIsDamage>300% damage per second</style>. Damaging targets collects <style=cIsUtility>data</style>. May instead heal allied targets at the cost of <style=cIsUtility>data</style>.".AutoFormat();
